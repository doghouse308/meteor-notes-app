...
if (Meteor.isServer) {
  describe('notes', function () {
    ...
    it('should not update note is user is not creator', function () {
      const title = 'This is an updated title';
    ...
    it('should return a zero notes for user\'s without notes', function () {
      const res = Meteor.server.publish_handlers.notes.apply({ userId: 'userWithoutNotes' });
      const notes = res.fetch();
